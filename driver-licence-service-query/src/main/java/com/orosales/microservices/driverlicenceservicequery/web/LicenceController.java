package com.orosales.microservices.driverlicenceservicequery.web;
...
public class LicenceController {
    ...
    @GetMapping
    public ResponseEntity<List<LicenceQuery>> listAll() throws Exception {
    ...
    public ResponseEntity<List<LicenceQuery>> listByFilter(@RequestParam(required = false) String status,
